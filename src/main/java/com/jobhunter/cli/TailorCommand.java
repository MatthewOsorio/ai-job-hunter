...
// @Command(name = "tailor", description = "Fetch a job posting by URL and tailor your resume to
// it.")
...
// @Option(names = { "-t", "--title" }, description = "Job title (optional)", defaultValue =
// "Unknown")
// private String title;

// @Option(names = { "-c", "--company" }, description = "Company name (optional)", defaultValue =
// "Unknown")
